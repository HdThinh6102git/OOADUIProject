...
const Posts = () => {
    //TEMPORARY
        ...
        const posts = [
            ...
            userId: 2,
            profilePic:
                "https://images.unsplash.com/photo-1623230590824-f39e31a0a608?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aW5kaWFuJTIwYm95fGVufDB8fDB8fA%3D%3D&w=1000&q=80",
            ...
            },
            {
                ...
                userId: 3,
                profilePic:
                    "https://cdn.pixabay.com/photo/2017/07/31/22/45/fashion-2561753_960_720.jpg",
